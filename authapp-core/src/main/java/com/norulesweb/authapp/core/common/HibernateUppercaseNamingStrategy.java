package com.norulesweb.authapp.core.common;

import org.hibernate.cfg.ImprovedNamingStrategy;

public class HibernateUppercaseNamingStrategy extends ImprovedNamingStrategy {

    private static final long serialVersionUID = -7829111496379449446L;
